...
run_program: GUIHandling.cpp Portfolio.cpp Display.cpp ReadData.cpp MovingAverageCrossover.cpp RiskAssesment.cpp Momentum.cpp SetDeposit.cpp Investment.cpp Dividend.cpp libs/glad/src/glad.c \
	...
	@g++ -o imgui_test GUIHandling.cpp Portfolio.cpp Display.cpp ReadData.cpp MovingAverageCrossover.cpp RiskAssesment.cpp Momentum.cpp SetDeposit.cpp Investment.cpp Dividend.cpp libs/glad/src/glad.c \
		imgui/imgui.cpp imgui/imgui_draw.cpp imgui/imgui_widgets.cpp imgui/imgui_tables.cpp \
		imgui/backends/imgui_impl_glfw.cpp imgui/backends/imgui_impl_opengl3.cpp \
